...
export function sidebar() {
  ...
  sidebarInner.innerHTML = `
    ...
    <div class="sidebar-list">
      ...
      <a
        ...
        menu-close
        class="sidebar-link"
        onClick='getMovieList("with_original_language=kn", "Kannada")'
        >Kannada</a
      >
      <a
        href="./movie-list.html"
  ...
  const genreLink = function () {
    for (const [genreId, genreName] of Object.entries(genreList)) {
      // Skip creating links for specified genres
      if (["Western", "War", "TV Movie", "Music","History"].includes(genreName)) {
        continue;
      }
